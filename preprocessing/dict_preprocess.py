...
class Lyrics_Columns(Enum):
     WORD_ORIGINAL = 'word_original'#1
     WORD_NO_PUNCTUATION = 'word_no_punctuation'#2
     WORD_CAN_SEARCH = 'word_can_search'#3
     WORD_INDEX_IN_SONG = 'word_index_in_song'#4
     LINE_INDEX_IN_SONG = 'line_index_in_song'#5
     STANZA_INDEX_IN_SONG = 'stanza_index_in_song'#6
     STANZA_DESCRIPTION = 'stanza_description'#7
     LINE_INDEX_IN_STANZA = 'line_index_in_stanza'#8
     WORD_INDEX_IN_LINE = 'word_index_in_line'#9


def preprocess_dict(lyrics_df):
    ...
    part_of_speech_df = pd.read_csv("preprocessing/broad_parts_of_speech_key.csv")
